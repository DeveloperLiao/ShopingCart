...
// 获取支付状态信息
export const getPayStatus = orderId => request({ url: `api/payment/weixin/queryPayStatus?${orderId}`, method: 'get' })
// 获取我的订单列表
export const getOrderList = (page, limit) => request({ url: `api/order/auth/${page}/${limit}`, method: 'get' })
